      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h2 style={{ fontSize: '24px', fontWeight: 800 }}>Orçamentador Inteligente SINAPI</h2>
          </div>
                    ...
                    >
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '8px' }}>
                        ...
                        <div style={{ textAlign: 'right', flexShrink: 0 }}>
                          <span style={{ fontSize: '10px', color: 'var(--text-dim)' }}>Preço SINAPI</span>
                          <p style={{ fontSize: '15px', fontWeight: 800, color: '#10b981' }}>
                      ...
                      >
                        <span style={{ fontSize: '12px', color: 'var(--text-muted)' }}>Quantidade ({item.unidade}):</span>
                        <input
                          type="number"
                          min="0.1"
                          step="0.1"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div className="glass-card">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              >
                <span style={{ fontSize: '12px', fontWeight: 600, color: '#60a5fa' }}>BDI:</span>
                <input
                  type="number"
                  style={{
                    width: '50px',
      ...
      {modalNovoOrcamento && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            >
              <h3 style={{ fontSize: '16px' }}>Criar Novo Orçamento</h3>
              <button
